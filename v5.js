...
function renderAudits(){
  ...
  return `${pageHead("Audits","Audit Terrain, maturité, 5S et standards","L’Audit Terrain BIA couvre dix domaines et cinquante critères. Chaque note exige une preuve.",'<button class="btn" data-new-audit>＋ AUDIT TERRAIN</button>')}
