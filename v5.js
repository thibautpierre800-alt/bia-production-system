...
const TEMPLATES=[
  ...
  {type:"BEFORE_AFTER",group:"Amélioration",title:"Fiche Avant / Après",desc:"Prouver visuellement le changement et son résultat"},
...
const DOCUMENT_SCHEMAS={
  ...
  BEFORE_AFTER:{title:"Fiche d’amélioration Avant / Après",visual:"beforeafter",fields:[["problem","1. Problème avant","Décrire la gêne, le risque ou la perte avec un fait mesurable."],["before","2. Situation AVANT","Décrire ce que la photo ou l’observation avant doit montrer."],["idea","3. Idée testée","Expliquer simplement le changement réalisé et par qui."],["after","4. Situation APRÈS","Décrire ce que la photo ou l’observation après doit montrer."],["result","5. Résultat mesuré","Comparer avant/après : temps, distance, défaut, risque, effort ou encours."],["safety","6. Contrôle sécurité / qualité","Confirmer qu’aucun risque ou défaut nouveau n’a été créé."],["standard","7. Standardisation","Standard modifié, personnes formées et date de vérification."],["recognition","8. Équipe et reconnaissance","Nommer les contributeurs et la décision de partage."]]},
...
function documentVisual(type,values={}){
  ...
  if(type==="BEFORE_AFTER")return `<div class="before-after-visual"><div><b>AVANT</b><span>${esc(values.before||"Problème visible et mesuré")}</span></div><div class="before-after-arrow">→</div><div><b>APRÈS</b><span>${esc(values.after||"Changement visible et résultat vérifié")}</span></div></div>`;
